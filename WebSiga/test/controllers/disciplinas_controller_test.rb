...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { cargaHoraria: @disciplina.cargaHoraria, nome: @disciplina.nome } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { cargaHoraria: @disciplina.cargaHoraria, nome: @disciplina.nome } }
